...
https://github.com/supaglue-labs/supaglue/assets/1925713/8cd4cdd0-f502-423e-8427-5e62104f8097
...
```shell
git clone -b v0.9.3 https://github.com/supaglue-labs/supaglue.git && cd supaglue
