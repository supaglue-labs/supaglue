...
Supaglue supports two ways of syncing data:

1. [Managed Syncs](#managed-syncs) - Supaglue writes raw data directly into your database.
1. [Data Listing API](#data-listing-api) - Supaglue writes to a Supaglue-hosted database and provides an API to paginate and transform data into your database schema.
...
## Managed Syncs vs Data Listing API

There are several differences between the two methods of hosting Destinations:

| Dimension        | Your application database                                     | Data Listing API                                            |
| ---------------- | ------------------------------------------------------------- | ----------------------------------------------------------- |
