...
You can access Standard Objects as part of [Managed Syncs](../../integration-patterns/managed-syncs), which can then be queried directly or accessed via the unified API.
