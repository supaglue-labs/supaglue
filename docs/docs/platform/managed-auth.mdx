...
| `loginUrl`      | The Oauth2 hostname for authorize and token endpoints.<br/> Use this for Salesforce sandbox accounts. It should be `https://test.salesforce.com` for that use case.<br/> <b>NOTE:</b> this should be uriEncoded                                                        | No       |
