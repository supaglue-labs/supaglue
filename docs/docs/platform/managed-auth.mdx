...
If you'd rather not write any Frontend code, you can use [Magic Links](../platform/magic-link) which will handle the input form and calling the connection API for you.

Otherwise, you can embed an input field in your frontend application to prompt customers to provide their API key. See a reference UI component and code below:
