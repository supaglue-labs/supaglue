...
Supaglue supports 3rd-party providers that use [OAuth 2.0](https://www.rfc-editor.org/rfc/rfc6749) for authentication.
...
| `providerName`          | The name of the third-party provider (e.g. `salesforce`, `hubspot`, ...)                                                                                                                                                                                               | Yes      |
...
| `autoStartOnConnection` | Whether to start syncs for objects defined in your SyncConfig upon a successful oauth connection. This query parameter overrides `auto_start_on_connection` set in your SyncConfig.                                                                                    | No       |
