...
1. Select the Provider and Destination you configured earlier, then under "[Common objects](./platform/common-schema/overview)" select `contact`, and click "Save".
...
Use the [Actions API](api/v2/actions/actions-api) or [Unified API](api/introduction) to create a contact object in Hubspot.
