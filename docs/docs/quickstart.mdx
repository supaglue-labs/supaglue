...
This guide will show you how to integrate Supaglue with your application in 10 minutes. By the end, you will have configured a CRM integration, connected a sample customer's CRM, and queried their account records.
...
Click on "Configure" and enter OAuth2 credentials for your HubSpot or Salesforce developers apps. You can find the credentials by following these guides:
...
In your frontend application, add an [Embedded Link](platform/embedded-links) to let customers authenticate their CRMs with your application using Supaglue.
...
See the complete [CRM API reference](api/v2/crm) for all endpoints.
