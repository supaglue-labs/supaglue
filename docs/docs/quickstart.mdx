...
First, create a free Supaglue Cloud account **[here](https://app.supaglue.io/sign-up)**.
...
:::info
For convenience, we offer Supaglue-managed OAuth apps for certain providers if you don't have one yourself. We highly recommend using your own OAuth app in production.
:::
