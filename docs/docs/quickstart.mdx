...
curl localhost:8080/crm/v1/accounts \
  -H 'x-api-key: 8o2kGDTHwTY6zcQV8gx7ep8vV7F2JNdeu95OR75MY7dlQJhzOiM4Ha/dKwXOTfDzDxVo+a6tZBrVxYfzJFIrgw==' \
  -H 'x-customer-id: 9ca0cd70-ae74-4f8f-81fd-9dd5d0a41677' \
...
curl localhost:8080/crm/v1/accounts \
  -H 'x-api-key: 8o2kGDTHwTY6zcQV8gx7ep8vV7F2JNdeu95OR75MY7dlQJhzOiM4Ha/dKwXOTfDzDxVo+a6tZBrVxYfzJFIrgw==' \
  -H 'x-customer-id: ea3039fa-27de-4535-90d8-db2bab0c0252' \
