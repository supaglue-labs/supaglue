                          ...
                          'oneOf':
                            [
                              ...
                              },
                              {
                                ...
                                'properties':
                                  {
                                    'category': { 'type': 'string', 'enum': ['engagement'] },
                                    'name':
                                      { 'type': 'string', 'enum': ['outreach'], 'title': 'provider_name_engagement' },
                                  },
                                'required': ['category', 'name'],
                              },
                            ],
    ...
    'jsonRequestBodyExample':
      {
        ...
        'objects':
          {
            'common': [{ 'name': 'common_object_name', 'schema_id': 'string' }],
            'standard': [{ 'name': 'standard_object_name', 'schema_id': 'string' }],
            'custom': [{ 'name': 'custom_object_name', 'schema_id': 'string' }],
          },
        'category': 'crm',
        'name': 'hubspot',
      },
