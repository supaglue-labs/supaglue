...
Not every object in a 3rd party provider is supported by Supaglue's common schema or is unifiable across providers. In addition to common objects, there are object provider-specific concepts that don't exist elsewhere. In these situations, you can access Standard Object data from 3rd party providers in their original format.
