...
:::info
A customer is an end-user in your application. You can create a Supaglue customer through the management portal, or programatically when they signup in your application using the [Management API](/api/mgmt#tag/Customers/operation/createCustomer).
:::
