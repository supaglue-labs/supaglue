...
To obtain a `{PROVIDER_NAME}`, use the [Supaglue API](../references/api/v2/crm) or management UI to create new integrations for your customers to have available for them to connect to.
