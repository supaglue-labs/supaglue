...
To obtain a `providerName`, use the [Supaglue API](../api/v2/crm/supaglue-unified-crm-api) or management UI to create new integrations for your customers to have available for them to connect to.
