...
${modifiedAfter ? `WHERE SystemModstamp > ${modifiedAfter.toISOString()} ORDER BY SystemModstamp ASC` : ''}`;
  ...
  public override async updateCustomObjectSchema(params: CustomObjectSchemaUpdateParams): Promise<void> {
    ...
    console.log(`existingObjectNonPrimaryAndLookupFields: `, existingObjectNonPrimaryAndLookupFields);
    ...
    const updateObjectResult = await this.#client.metadata.update(
      'CustomObject',
      toSalesforceCustomObjectCreateParams(objectName, params.labels, params.description, primaryField!, updatedFields)
    );
