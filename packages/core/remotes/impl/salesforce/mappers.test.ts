    ...
    test('should correctly convert a SalesforceCustomObject to CustomObject', () => {
      const salesforceCustomObject = {
        ...
        fields: [
          ...
          { name: 'TestField2', label: 'FieldLabel2', type: 'datetime', nillable: true },
          { name: 'TestField3', label: 'FieldLabel3', type: 'double', precision: 3, scale: 0, nillable: true },
          { name: 'TestField4', label: 'FieldLabel4', type: 'int', precision: 18, scale: 0, nillable: true },
          { name: 'TestField5', label: 'FieldLabel5', type: 'Address', nillable: true },
          {
            name: 'TestField6',
            label: 'FieldLabel6',
            type: 'picklist',
