...
import type { CustomObject as SalesforceCustomObject } from 'jsforce/lib/api/metadata/schema';
import {
  CRM_BILLING_ADDRESS,
  CRM_FAX,
  CRM_MAILING_ADDRESS,
    ...
    test('should correctly convert a SalesforceCustomObject to CustomObject', () => {
      const salesforceCustomObject = {
        ...
        fields: [
          ...
          { fullName: 'TestField2', label: 'FieldLabel2', type: 'DateTime', required: false },
          { fullName: 'TestField3', label: 'FieldLabel3', type: 'Number', precision: 3, scale: 0, required: false },
          { fullName: 'TestField4', label: 'FieldLabel4', type: 'Number', precision: 18, scale: 0, required: false },
          { fullName: 'TestField5', label: 'FieldLabel5', type: 'Address', required: false },
          {
            fullName: 'TestField6',
            label: 'FieldLabel6',
            type: 'Picklist',
