...
public class InlineResponse2003 extends Pagination {
  @SerializedName("results")
  private List<Opportunity> results = null;

  public InlineResponse2003 results(List<Opportunity> results) {
    this.results = results;
    return this;
  }

  public InlineResponse2003 addResultsItem(Opportunity resultsItem) {
    if (this.results == null) {
      this.results = new ArrayList<Opportunity>();
    }
  ...
  **/
  ...
  public void setResults(List<Opportunity> results) {
    this.results = results;
  }
