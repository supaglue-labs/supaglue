...
public class LeadsApiTest {
    ...
    public void createLeadTest() throws Exception {
        LeadsBody body = null;
        InlineResponse2012 response = api.createLead(body);
    ...
    public void getLeadTest() throws Exception {
        String leadId = null;
        String expand = null;
        Lead response = api.getLead(leadId, expand);
    ...
    public void getLeadsTest() throws Exception {
        ...
        InlineResponse2002 response = api.getLeads(createdAfter, createdBefore, updatedAfter, updatedBefore, cursor, expand, pageSize);
    ...
    public void updateLeadTest() throws Exception {
        ...
        String leadId = null;
        InlineResponse2012 response = api.updateLead(body, leadId);
