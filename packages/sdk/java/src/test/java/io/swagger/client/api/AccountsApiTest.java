...
public class AccountsApiTest {
    ...
    public void createAccountTest() throws Exception {
        ...
        InlineResponse201 response = api.createAccount(body);
    ...
    public void getAccountTest() throws Exception {
        ...
        String expand = null;
        Account response = api.getAccount(accountId, expand);
    ...
    public void getAccountsTest() throws Exception {
        ...
        InlineResponse200 response = api.getAccounts(createdAfter, createdBefore, updatedAfter, updatedBefore, cursor, expand, pageSize);
    ...
    public void updateAccountTest() throws Exception {
        ...
        String accountId = null;
        InlineResponse201 response = api.updateAccount(body, accountId);
