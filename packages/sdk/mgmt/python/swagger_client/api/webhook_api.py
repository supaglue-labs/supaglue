...
class WebhookApi(object):
    ...
    def delete_webhook(self, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_webhook_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.delete_webhook_with_http_info(**kwargs)  # noqa: E501
            return data

    def delete_webhook_with_http_info(self, **kwargs):  # noqa: E501
        """Delete webhook  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_webhook_with_http_info(async_req=True)
        >>> result = thread.get()
