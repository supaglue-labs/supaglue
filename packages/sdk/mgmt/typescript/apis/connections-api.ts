...
export const ConnectionsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async deleteConnection(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<void>>> {
...
export const ConnectionsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        async deleteConnection(options?: AxiosRequestConfig): Promise<AxiosResponse<void>> {
...
export class ConnectionsApi extends BaseAPI {
     ...
     */
    public async deleteConnection(options?: AxiosRequestConfig) : Promise<AxiosResponse<void>> {
