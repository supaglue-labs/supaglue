...
public class Lead {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(addresses, company, convertedAccountId, convertedAccount, convertedContactId, convertedContact, convertedDate, emailAddresses, firstName, id, lastName, leadSource, ownerId, owner, phoneNumbers, createdAt, updatedAt, title);
  }
