...
import io.swagger.client.model.OpportunitiesSearchBody;
...
public class OpportunitiesApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getOpportunitiesCall(String xCustomerId, String xProviderName, OffsetDateTime createdAfter, OffsetDateTime createdBefore, OffsetDateTime modifiedAfter, OffsetDateTime modifiedBefore, String cursor, String expand, String pageSize, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call getOpportunitiesValidateBeforeCall(String xCustomerId, String xProviderName, OffsetDateTime createdAfter, OffsetDateTime createdBefore, OffsetDateTime modifiedAfter, OffsetDateTime modifiedBefore, String cursor, String expand, String pageSize, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getOpportunitiesCall(xCustomerId, xProviderName, createdAfter, createdBefore, modifiedAfter, modifiedBefore, cursor, expand, pageSize, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public InlineResponse2003 getOpportunities(String xCustomerId, String xProviderName, OffsetDateTime createdAfter, OffsetDateTime createdBefore, OffsetDateTime modifiedAfter, OffsetDateTime modifiedBefore, String cursor, String expand, String pageSize) throws ApiException {
        ApiResponse<InlineResponse2003> resp = getOpportunitiesWithHttpInfo(xCustomerId, xProviderName, createdAfter, createdBefore, modifiedAfter, modifiedBefore, cursor, expand, pageSize);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<InlineResponse2003> getOpportunitiesWithHttpInfo(String xCustomerId, String xProviderName, OffsetDateTime createdAfter, OffsetDateTime createdBefore, OffsetDateTime modifiedAfter, OffsetDateTime modifiedBefore, String cursor, String expand, String pageSize) throws ApiException {
        com.squareup.okhttp.Call call = getOpportunitiesValidateBeforeCall(xCustomerId, xProviderName, createdAfter, createdBefore, modifiedAfter, modifiedBefore, cursor, expand, pageSize, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getOpportunitiesAsync(String xCustomerId, String xProviderName, OffsetDateTime createdAfter, OffsetDateTime createdBefore, OffsetDateTime modifiedAfter, OffsetDateTime modifiedBefore, String cursor, String expand, String pageSize, final ApiCallback<InlineResponse2003> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getOpportunitiesValidateBeforeCall(xCustomerId, xProviderName, createdAfter, createdBefore, modifiedAfter, modifiedBefore, cursor, expand, pageSize, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<InlineResponse2003>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    ...
    /**
     * Build call for searchOpportunities
     * @param body  (required)
     * @param xCustomerId The customer ID that uniquely identifies the customer in your application (required)
     * @param xProviderName The provider name (required)
     * @param cursor The pagination cursor value (optional)
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call searchOpportunitiesCall(OpportunitiesSearchBody body, String xCustomerId, String xProviderName, String cursor, String pageSize, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
        
        // create path and map variables
        String localVarPath = "/opportunities/_search";
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call searchOpportunitiesValidateBeforeCall(OpportunitiesSearchBody body, String xCustomerId, String xProviderName, String cursor, String pageSize, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new ApiException("Missing the required parameter 'body' when calling searchOpportunities(Async)");
        }
        // verify the required parameter 'xCustomerId' is set
        if (xCustomerId == null) {
            throw new ApiException("Missing the required parameter 'xCustomerId' when calling searchOpportunities(Async)");
        }
        // verify the required parameter 'xProviderName' is set
        if (xProviderName == null) {
            throw new ApiException("Missing the required parameter 'xProviderName' when calling searchOpportunities(Async)");
        }
        
        com.squareup.okhttp.Call call = searchOpportunitiesCall(body, xCustomerId, xProviderName, cursor, pageSize, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public InlineResponse2003 searchOpportunities(OpportunitiesSearchBody body, String xCustomerId, String xProviderName, String cursor, String pageSize) throws ApiException {
        ApiResponse<InlineResponse2003> resp = searchOpportunitiesWithHttpInfo(body, xCustomerId, xProviderName, cursor, pageSize);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<InlineResponse2003> searchOpportunitiesWithHttpInfo(OpportunitiesSearchBody body, String xCustomerId, String xProviderName, String cursor, String pageSize) throws ApiException {
        com.squareup.okhttp.Call call = searchOpportunitiesValidateBeforeCall(body, xCustomerId, xProviderName, cursor, pageSize, null, null);
        Type localVarReturnType = new TypeToken<InlineResponse2003>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Search Opportunities (asynchronously)
     * 
     * @param body  (required)
     * @param xCustomerId The customer ID that uniquely identifies the customer in your application (required)
     * @param xProviderName The provider name (required)
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call searchOpportunitiesAsync(OpportunitiesSearchBody body, String xCustomerId, String xProviderName, String cursor, String pageSize, final ApiCallback<InlineResponse2003> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = searchOpportunitiesValidateBeforeCall(body, xCustomerId, xProviderName, cursor, pageSize, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<InlineResponse2003>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
