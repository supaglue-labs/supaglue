...
public class ContactsApiTest {
    ...
    public void createContactTest() throws Exception {
        ...
        InlineResponse2011 response = api.createContact(body, customerId, providerName);
    ...
    public void getContactTest() throws Exception {
        ...
        String expand = null;
        Contact response = api.getContact(customerId, providerName, contactId, expand);
    ...
    public void getContactsTest() throws Exception {
        ...
        InlineResponse2001 response = api.getContacts(customerId, providerName, createdAfter, createdBefore, updatedAfter, updatedBefore, cursor, expand, pageSize);
    ...
    public void updateContactTest() throws Exception {
        ...
        String providerName = null;
        String contactId = null;
        InlineResponse2011 response = api.updateContact(body, customerId, providerName, contactId);
