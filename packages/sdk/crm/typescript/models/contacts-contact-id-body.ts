 ...
 */
import { CreateUpdateContact } from './create-update-contact';
/**
 * 
 * @export
 * @interface ContactsContactIdBody
 */
export interface ContactsContactIdBody {
    /**
     * 
     * @type {CreateUpdateContact}
     * @memberof ContactsContactIdBody
     */
