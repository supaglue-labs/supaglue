 ...
 */
import { OpportunitiesSearchFilters } from './opportunities-search-filters';
/**
 * 
 * @export
 * @interface OpportunitiesSearchBody
 */
export interface OpportunitiesSearchBody {
    /**
     * 
     * @type {OpportunitiesSearchFilters}
     * @memberof OpportunitiesSearchBody
     */
