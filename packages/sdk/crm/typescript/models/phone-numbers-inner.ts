 ...
 * 
 * @export
 * @interface PhoneNumbersInner
 */
export interface PhoneNumbersInner {
    /**
     * 
     * @type {string}
     * @memberof PhoneNumbersInner
     */
     ...
     * @memberof PhoneNumbersInner
     */
    phoneNumberType: PhoneNumbersInnerPhoneNumberTypeEnum;
}
...
/**
    ...
    * @enum {string}
    */
export enum PhoneNumbersInnerPhoneNumberTypeEnum {
    Primary = 'primary',
    Mobile = 'mobile',
    Fax = 'fax'
}
