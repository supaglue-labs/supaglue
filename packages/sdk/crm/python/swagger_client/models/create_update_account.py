...
class CreateUpdateAccount(object):
    ...
    def __init__(self, description=None, industry=None, name=None, number_of_employees=None, website=None, addresses=None, phone_numbers=None, owner_id=None, custom_fields=None):  # noqa: E501
