...
class AnyOfinlineResponse2005Body(object):
    ...
    def __init__(self):  # noqa: E501
        """AnyOfinlineResponse2005Body - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AnyOfinlineResponse2005Body, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AnyOfinlineResponse2005Body):
            return False
