...
class Opportunity(object):
    ...
    def __init__(self, account_id=None, account=None, amount=None, close_date=None, description=None, id=None, last_activity_at=None, name=None, owner_id=None, owner=None, created_at=None, updated_at=None, stage=None, status=None):  # noqa: E501
