...
class ContactsBody(object):
    ...
    def __init__(self, model=None):  # noqa: E501
        """ContactsBody - a model defined in Swagger"""  # noqa: E501
        self._model = None
    ...
    @property
    def model(self):
        """Gets the model of this ContactsBody.  # noqa: E501


        :return: The model of this ContactsBody.  # noqa: E501
    ...
    def model(self, model):
        """Sets the model of this ContactsBody.


        :param model: The model of this ContactsBody.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ContactsBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ContactsBody):
            return False
