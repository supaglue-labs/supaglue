...
# **create_contact**
> InlineResponse2011 create_contact(body)
...
# **get_contact**
> Contact get_contact(contact_id, expand=expand)
...
try:
    # Get contact
    api_response = api_instance.get_contact(contact_id, expand=expand)
    pprint(api_response)
except ApiException as e:
...
# **get_contacts**
> InlineResponse2001 get_contacts(created_after=created_after, created_before=created_before, updated_after=updated_after, updated_before=updated_before, cursor=cursor, expand=expand, page_size=page_size)
...
try:
    # List contacts
    api_response = api_instance.get_contacts(created_after=created_after, created_before=created_before, updated_after=updated_after, updated_before=updated_before, cursor=cursor, expand=expand, page_size=page_size)
    pprint(api_response)
except ApiException as e:
...
# **update_contact**
> InlineResponse2011 update_contact(body, contact_id)
...
try:
    # Update contact
    api_response = api_instance.update_contact(body, contact_id)
    pprint(api_response)
except ApiException as e:
