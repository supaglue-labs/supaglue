...
export type SubmitFormResponse = operations['submitForm']['responses'][200]['content']['application/json'];
...
export type ListFormsResponse = operations['listForms']['responses'][200]['content']['application/json'];
...
export type GetFormFieldsResponse = operations['getFormFields']['responses'][200]['content']['application/json'];
