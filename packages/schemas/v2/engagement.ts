...
export type GetSequenceResponse = operations['getSequence']['responses'][200]['content']['application/json'];
...
export type ListSequencesResponse = operations['listSequences']['responses'][200]['content']['application/json'];
...
export type CreateSequenceResponse = operations['createSequence']['responses'][201]['content']['application/json'];
...
export type GetMailboxResponse = operations['getMailbox']['responses'][200]['content']['application/json'];
...
export type ListMailboxesResponse = operations['listMailboxes']['responses'][200]['content']['application/json'];
...
export type GetSequenceStateResponse = operations['getSequenceState']['responses'][200]['content']['application/json'];
