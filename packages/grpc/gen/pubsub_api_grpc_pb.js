...
var pubsub_api_pb = require('./pubsub_api_pb.js');

function serialize_eventbus_v1_FetchRequest(arg) {
  if (!(arg instanceof pubsub_api_pb.FetchRequest)) {
...
function deserialize_eventbus_v1_FetchRequest(buffer_arg) {
  return pubsub_api_pb.FetchRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_eventbus_v1_FetchResponse(arg) {
  if (!(arg instanceof pubsub_api_pb.FetchResponse)) {
...
function deserialize_eventbus_v1_FetchResponse(buffer_arg) {
  return pubsub_api_pb.FetchResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_eventbus_v1_PublishRequest(arg) {
  if (!(arg instanceof pubsub_api_pb.PublishRequest)) {
...
function deserialize_eventbus_v1_PublishRequest(buffer_arg) {
  return pubsub_api_pb.PublishRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_eventbus_v1_PublishResponse(arg) {
  if (!(arg instanceof pubsub_api_pb.PublishResponse)) {
...
function deserialize_eventbus_v1_PublishResponse(buffer_arg) {
  return pubsub_api_pb.PublishResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_eventbus_v1_SchemaInfo(arg) {
  if (!(arg instanceof pubsub_api_pb.SchemaInfo)) {
...
function deserialize_eventbus_v1_SchemaInfo(buffer_arg) {
  return pubsub_api_pb.SchemaInfo.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_eventbus_v1_SchemaRequest(arg) {
  if (!(arg instanceof pubsub_api_pb.SchemaRequest)) {
...
function deserialize_eventbus_v1_SchemaRequest(buffer_arg) {
  return pubsub_api_pb.SchemaRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_eventbus_v1_TopicInfo(arg) {
  if (!(arg instanceof pubsub_api_pb.TopicInfo)) {
...
function deserialize_eventbus_v1_TopicInfo(buffer_arg) {
  return pubsub_api_pb.TopicInfo.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_eventbus_v1_TopicRequest(arg) {
  if (!(arg instanceof pubsub_api_pb.TopicRequest)) {
...
function deserialize_eventbus_v1_TopicRequest(buffer_arg) {
  return pubsub_api_pb.TopicRequest.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var PubSubService = (exports.PubSubService = {
  ...
  subscribe: {
    ...
    requestStream: true,
    responseStream: true,
    requestType: pubsub_api_pb.FetchRequest,
    responseType: pubsub_api_pb.FetchResponse,
  ...
  getSchema: {
    ...
    requestType: pubsub_api_pb.SchemaRequest,
    responseType: pubsub_api_pb.SchemaInfo,
  ...
  getTopic: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: pubsub_api_pb.TopicRequest,
    responseType: pubsub_api_pb.TopicInfo,
  ...
  publish: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: pubsub_api_pb.PublishRequest,
    responseType: pubsub_api_pb.PublishResponse,
