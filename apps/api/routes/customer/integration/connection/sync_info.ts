...
import { GetSyncInfosPathParams, GetSyncInfosRequest, GetSyncInfosResponse } from '@supaglue/schemas/customer';
...
export default function init(app: Router): void {
  ...
  router.get(
    ...
    async (
      ...
      const syncInfoList = await syncService.getSyncInfoList(req.sg.connectionId);
